...
DEFAULT_CONFIG = {
    ...
    "global": {
        ...
        "code_gen_agent_arn": os.getenv("CODE_GEN_AGENT_ARN", "arn:aws:bedrock-agentcore:us-east-1:817323390093:runtime/ray_code_interpreter-FKoWFR2k9A"),
    ...
    "spark": {
        ...
        "supervisor_arn": os.getenv("SPARK_SUPERVISOR_ARN", "arn:aws:bedrock-agentcore:us-east-1:817323390093:runtime/spark_supervisor_agent-kSQUxI8Tqu")
    },
    "postgres": {
        "connections": [],
